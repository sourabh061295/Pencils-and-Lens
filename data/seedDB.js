...
var artLinks = require("./models/artLinks");
var imageLinks = require("./models/imageLinks");
var specialLinks = require("./models/specialLinks");
...
function seedDB(){
    ...
    specialLinks.deleteMany({}, function(err){
        ...
        console.log("Special links added");
    });
 }
